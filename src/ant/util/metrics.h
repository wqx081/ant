...
#define METRIC_DEFINE_entity(name)                               \
  ::ant::MetricEntityPrototype METRIC_ENTITY_##name(#name)
...
#define METRIC_DEFINE_counter(entity, name, label, unit, desc)   \
  ::ant::CounterPrototype METRIC_##name(                        \
      ::ant::MetricPrototype::CtorArgs(#entity, #name, label, unit, desc))

#define METRIC_DEFINE_gauge_string(entity, name, label, unit, desc, ...) \
  ::ant::GaugePrototype<std::string> METRIC_##name(                 \
...
#define METRIC_DECLARE_entity(name) \
  extern ::ant::MetricEntityPrototype METRIC_ENTITY_##name
#define METRIC_DECLARE_counter(name)                             \
  extern ::ant::CounterPrototype METRIC_##name
#define METRIC_DECLARE_gauge_string(name) \
  extern ::ant::GaugePrototype<std::string> METRIC_##name
#define METRIC_DECLARE_gauge_bool(name) \
  extern ::ant::GaugePrototype<bool> METRIC_##name
#define METRIC_DECLARE_gauge_int32(name) \
  extern ::ant::GaugePrototype<int32_t> METRIC_##name
#define METRIC_DECLARE_gauge_uint32(name) \
  extern ::ant::GaugePrototype<uint32_t> METRIC_##name
#define METRIC_DECLARE_gauge_int64(name) \
  extern ::ant::GaugePrototype<int64_t> METRIC_##name
#define METRIC_DECLARE_gauge_uint64(name) \
  extern ::ant::GaugePrototype<uint64_t> METRIC_##name
#define METRIC_DECLARE_gauge_double(name) \
  extern ::ant::GaugePrototype<double> METRIC_##name
